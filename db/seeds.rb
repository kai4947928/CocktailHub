...
base_scotch = BaseLiquor.create!(name: 'スコッチ')
base_irish_whiskey = BaseLiquor.create!(name: 'アイリッシュウイスキー')
base_beer = BaseLiquor.create!(name: 'ビール')
base_white_wine = BaseLiquor.create!(name: '白ワイン')
base_red_wine = BaseLiquor.create!(name: '赤ワイン')

#材料
ingredient_rum = Ingredient.create!(name: 'ラム')
ingredient_gin = Ingredient.create!(name: 'ジン')
ingredient_tequila = Ingredient.create!(name: 'テキーラ')
ingredient_vodka = Ingredient.create!(name: 'ウォッカ')
ingredient_whiskey = Ingredient.create!(name: 'ウイスキー')
ingredient_scotch = Ingredient.create!(name: 'スコッチ')
ingredient_irish_whiskey = Ingredient.create!(name: 'アイリッシュウイスキー')
ingredient_beer = Ingredient.create!(name: 'ビール')
ingredient_white_wine = Ingredient.create!(name: '白ワイン')
ingredient_red_wine = Ingredient.create!(name: '赤ワイン')
...
ingredient_casis = Ingredient.create!(name: 'カシスリキュール')
